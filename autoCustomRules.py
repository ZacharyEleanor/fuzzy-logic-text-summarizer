...
def customRule():
    ...
    rule36  = ctrl.Rule(title_word["poor"] & sentence_length["poor"] & sentence_location["poor"] & numerical_data["poor"] & thematic_keyword["average"] & proper_noun["poor"] & sentence_similarity["good"] & term_weig